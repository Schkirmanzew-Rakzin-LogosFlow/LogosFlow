...
- Model tags are generated by `docker/llm/scripts/init-models.sh` from the files in `docker/llm/modelslinks/*.gguf`. Filenames are lowercased/sanitized (non-alphanumerics become `-`) and tagged with context sizes like `:ctx4096` and `:ctx8192`.
- Current GGUF files create the following tags used by LiteLLM: `qwen3-4b-q4_k_m:ctx4096/ctx8192`, `qwen3-8b-q4_k_m:ctx4096/ctx8192`, `qwen2.5-7b-instruct-q3_k_m:ctx4096/ctx8192`, `qwen2.5-vl-7b-instruct-q4_k_m:ctx4096`, `phi-4-mini-reasoning-q4_k_m:ctx4096/ctx8192`, `gemma-2-9b-it-q4_k_m:ctx4096/ctx8192`, `mistral-7b-instruct-v0.3-q4_k_m:ctx4096/ctx8192`.
